...
#import "ARMultiSelectGestureRecognizer.h"

@interface ARMultiSelectGestureRecognizer ()
...
@implementation ARMultiSelectGestureRecognizer

- (ARMultiSelectGestureRecognizer *)initWithTarget:(id)target action:(SEL)action toggleSelectedHandler:(void (^)(UICollectionViewCell *))handler
{
